...
describe('Actions.Files', () => {
    ...
    it('getFilePublicLink', async () => {
        ...
        nock(Client4.getBaseRoute()).
            ...
            query(true).
            reply(200, {
                link: 'https://xenia.com/files/ndans23ry2rtjd1z73g6i5f3fc/public?h=rE1-b2N1VVVMsAQssjwlfNawbVOwUy1TRDuTeGC_tys',
            });
        ...
        assert.equal('https://xenia.com/files/ndans23ry2rtjd1z73g6i5f3fc/public?h=rE1-b2N1VVVMsAQssjwlfNawbVOwUy1TRDuTeGC_tys', filePublicLink);
