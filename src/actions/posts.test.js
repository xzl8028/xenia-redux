...
describe('Actions.Posts', () => {
    ...
    it('getOpenGraphMetadata', async () => {
        ...
        const url = 'https://about.xenia.com';
        const docs = 'https://docs.xenia.com/';

        nock(Client4.getBaseRoute()).
            post('/opengraph').
            reply(200, {type: 'article', url: 'https://about.xenia.com/', title: 'Xenia private cloud messaging', description: 'Open source,  private cloud\nSlack-alternative, \nWorkplace messaging for web, PCs and phones.'});
